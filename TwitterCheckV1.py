...
By Xcode @iPASHAx404
     ...
     \:| :/======"="======\| |:/
      /_:-`    
        ...
        **************************************
        * -> Development: @iPASHAx404          *
        * -> Twitter @X.404# !/usr/bin/env python
import time
import requests
import optparse
import time as mm
...
headers = {"Accept": "application/json", "X-Twitter-Client-Version": "8.41.1",  "Accept-Language": "en", "Accept-Encoding": "gzip, deflate",  "User-Agent": "Twitter-iPhone/8.41.1 iOS/Enjoy (ByXcode;@ipashax,4;;;;;1;https://twitter.com/ipasha)", "Connection": "close", "X-Twitter-Client-Limit-Ad-Tracking": "0", "X-Twitter-API-Version": "5", "X-Twitter-Client": "Twitter-Xcode0x"}
